...
| `gateway_install_firewalld_zone` | `""` | firewalld zone to open the LINSTOR Gateway ports in; empty uses the default zone, set it when a zone is bound to a source; ignored by UFW |
